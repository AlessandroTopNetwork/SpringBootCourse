...
public class MyDemoLoggingAspect {
	...
	@After("execution(* com.aop.demo.dao.AccountDAO.findAccounts(..))") // after exectuion method into this package and it method findAccounts in this case then start code into this After point
	public void afterFinallyFindAccountAdvice(JoinPoint joinPoint) {
		
        String method = joinPoint.getSignature().toShortString();
        System.out.println("\n=====>>> Executing Exception @After ( finally ) on method: " + method);
    ...
    @AfterThrowing(
            ...
            throwing = "e")
    public void afterThrowException(JoinPoint theJoinPoint, Throwable e) { 
    	
        // print out which method we are advising on
        String method = theJoinPoint.getSignature().toShortString();
        System.out.println("\n=====>>> Executing Exception @AfterReturning on method: " + method);
