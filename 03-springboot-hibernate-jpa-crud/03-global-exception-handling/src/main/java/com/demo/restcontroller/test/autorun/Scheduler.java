...
//                 Runtime.getRuntime().exec("cmd /c start http://localhost:8080/api/getStudents");
//             } else if (os.contains("nix") || os.contains("nux")) {
//                 // Sistema operativo basato su Unix (Linux)
//                 log.info("Sistema operativo: Unix (Linux)");
//                 Runtime.getRuntime().exec("xdg-open http://localhost:8080/api/getStudents");
//             }else if (os.contains("mac")) {
//                 // Sistema operativo macOS
//                 log.info("Sistema operativo: MacOS");
//                 Runtime.getRuntime().exec("open http://localhost:8080/api/getStudents");
//             } else {
